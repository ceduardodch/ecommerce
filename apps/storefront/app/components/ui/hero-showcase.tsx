      ...
      <div className="relative mx-auto max-w-6xl px-4 pt-10 pb-16 lg:grid lg:grid-cols-[1fr_1.15fr] lg:items-center lg:gap-10 lg:pt-16 lg:pb-24">
        ...
        <div className="text-center lg:text-left">
          <p className="hs-enter text-[11px] font-semibold uppercase tracking-[0.22em] text-[#d3fa99]">
            MGC · {product.collection || "Granito"} · {product.diameterCm || 32}{" "}
            cm
          </p>
          <h1
          ...
          {product.comboPrice && (
            <p
              className="hs-enter mt-2 text-[14px] font-semibold text-emerald-300"
              style={{ animationDelay: "0.42s" }}
            >
              Precio verde desde {product.comboMinimumItems || 3}: $
              {product.comboPrice.amount.toFixed(2)} c/u
            </p>
          )}
