...
// --- Server-safe non-WhatsApp button ---
...
// --- WhatsApp-specific button (must wrap TrackedWhatsAppLink) ---
export function WhatsAppButton({
  ...
  /** href fallback when product is not available (e.g., home advisory) */
  waHref?: string
}) {
  const cls = `${variantClass.whatsapp} ${className ?? ""}`
  ...
  // Advisory link (no product) — plain anchor, no tracking product required
  return (
    <a
      href={waHref ?? "#"}
      target="_blank"
