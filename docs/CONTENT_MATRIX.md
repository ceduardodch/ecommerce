...
| Energia / sonido / decoracion | `wellness-tambor-lengua-real.jpg` para `BIEN-TAMBOR-LENGUA-8-NOTAS`; `wellness-aroma.svg` para el resto | Catalogo, hero bienestar y landing SKU | `BIEN-CUENCO-BRONCE-8`, `BIEN-CUENCO-BRONCE-9`, `BIEN-TAMBOR-LENGUA-8-NOTAS`, `BIEN-CASCADA-HUMO-OM-GANESHA-TORRE`, `BIEN-PENDULO-7-CHAKRAS`, `BIEN-LAMPARA-SAL-HIMALAYA-10KG` | Ritual, sonido y ambiente sin claims medicos | `product_interest` / `whatsapp_opened` |
