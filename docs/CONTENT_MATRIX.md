...
| ----------------------------- | ---------------------- | --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------- | -------------------------------------- |
| Hero bienestar                | `wellness-tambor-lengua-real.jpg` | `bienestar.b2b.com.ec` hero | Vertical bienestar                                                                                                                                                             | Producto real, pausa y sonido                | `page_view` / `view_content`           |
...
| Hogar Zen / te                | `wellness-bowl.svg`    | Catalogo y landing SKU      | `BIEN-JUEGO-TE-AAA`, termos, teteras y juegos de te del catalogo WhatsApp                                                                                                      | Ritual de te y regalo                        | `product_interest` / `whatsapp_opened` |
| Energia / sonido / decoracion | `wellness-tambor-lengua-real.jpg` para `BIEN-TAMBOR-LENGUA-8-NOTAS`; `wellness-aroma.svg` para el resto | Catalogo, hero bienestar y landing SKU | Cuencos, tambor, cascadas, pendulos, lampara de sal, moxas, portainciensos, saumador, velas, incienso, Nataraj y billete simbolico del catalogo WhatsApp                         | Ritual, sonido y ambiente sin claims medicos | `product_interest` / `whatsapp_opened` |
| Tesoros plata / acero         | `wellness-aroma.svg`   | Catalogo y landing SKU      | Argollas, dijes, aretes, anillos, collares, cadena y piezas de acero/plata del catalogo WhatsApp                                                                                 | Accesorio y regalo                           | `product_interest` / `whatsapp_opened` |
| Cuidado personal              | `wellness-aroma.svg`   | Catalogo y landing SKU      | `BIEN-PIEDRA-ALUMBRE`, `BIEN-LIMPIADOR-LENGUA-COBRE`                                                                                                                           | Rutina personal sin claims medicos           | `product_interest` / `whatsapp_opened` |
...
El catalogo publico de WhatsApp `https://wa.me/c/593979854915` solo expone sin login una imagen OpenGraph. Esa foto queda aprobada como `wellness-tambor-lengua-real.jpg` para sonido/pausa; el resto de fotos deben salir de WhatsApp Web autenticado, exportacion manual o `data/biblioteca`.
